...
*    [Нерекурсивный разворот списка - история и решения](#нерекурсивный-разворот-списка---история-и-решения)
...
### Нерекурсивный разворот списка - история и решения

Поскольку до 2014 года не было настоящих constexpr-функций, были прежние "квадранты" метапрограммирования на списках типов и кортежах значений.
А значит было одно лишь функциональное программирование, где без рекурсии невозможно решать задачи. Проговорим еще раз то, в чем заключается
...
И наконец, последнее что мы могли бы сделать - это реализовать еще более универсальный алгоритм, не требующий регистрации типов. Впрочем, лично
я, вероятно, не смог бы придумать такое решение достаточно быстро. Однако, есть прекрасное решение от Олега Фатxиева, представленное на C++ 
Russia 2019. И выглядит оно так:
