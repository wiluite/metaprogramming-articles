...
инстанцировании что то "выкинет" (нельзя выкинуть основной шаблон класса никак не упоминающий наше условие разрешения/запрета перегрузки), а
потому, что специализация, представляющая второй рекурсивный случай, станет более подходящей для вызова.
